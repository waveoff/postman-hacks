...
// I'm using this code to make it easy to refresh the environment variables 
// used as storage for API authorization bearers in Postman. 
...
// 4. Replace "YOUR_RESPONSE_JSON_..._TOKEN_KEY" placeholders with your real JSON keys (fron API auth response)
// 5. Send Auth Request, check it went successfuly and you have proper Auth Response (Status: 200 OK)
// 6. Check if your Env Variables are filled with values from Auth Response JSON
